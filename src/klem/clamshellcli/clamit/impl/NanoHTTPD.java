...
import klem.clamshellcli.clamit.cmd.MockHttpCommand;
...
public class NanoHTTPD
{
	...
	{
		console.writeOutput( method + " '" + uri + "' " );

		Enumeration e = header.propertyNames();
		while ( e.hasMoreElements())
		{
			String value = (String)e.nextElement();
			console.writeOutput( "  HDR: '" + value + "' = '" +
		...
		{
			String value = (String)e.nextElement();
			console.writeOutput( "  UPLOADED: '" + value + "' = '" +
	...
	public NanoHTTPD( int port, File wwwroot, IOConsole console ) throws IOException
	{
		myTcpPort = port;
		...
		console.writeOutput( "NanoHTTPD 1.25 (C) 2001,2005-2011 Jarno Elonen and (C) 2010 Konstantinos Togias");
	...
	public void stop()
	{
		try
		{
			...
			console.writeOutput(String.format("%n%s", ioe.getMessage()));
		}
...
//		catch( IOException ioe )
//		{
//			console.writeOutput( "Couldn't start server:\n" + ioe );
//			System.exit( -1 );
//		}
//
//		console.writeOutput( "Now serving files in port " + port + " from \"" + wwwroot + "\"" );
//		console.writeOutput( "Hit Enter to stop.\n" );
//
...
//	}
	...
	public String toString() {
		...
		builder.append("NanoHTTPD [Port=");
		builder.append(myTcpPort);
		builder.append(", RootDir=");
		builder.append(myRootDir);
		builder.append(", Socket=");
		builder.append(myServerSocket);
		builder.append("]");
		...
		private String saveTmpFile(byte[] b, int offset, int len)
		{
			...
			if (len > 0)
			{
				...
				try {
					...
					console.writeOutput("Error: " + e.getMessage());
				}
			}
			return path;
		}
